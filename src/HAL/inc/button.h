/**
 * @file button.h
 * @author Copyright FWD_Advanced(c) 2022
 * @brief 
 * @version 0.1
 * @date 2022-08-28
 * 
...
//*******************************************************************************************************************************
//! \b Header
//! \b Section1 : Interface Macros
//! \b Section2 : Interface Types
...
#define LOW_WHEN_PRESSED          ((bool)0)
#define HIGH_WHEN_PRESSED         ((bool)1)

#define PRESSED                   ((bool)1)
#define NOT_PRESSED               ((bool)0)
...
typedef struct {
	const uint8_t ui8Port;
	const uint8_t ui8Pin;
	const bool boolWhenPressed;
	void (*ptrfCallBackFunction)();
} button_t;
